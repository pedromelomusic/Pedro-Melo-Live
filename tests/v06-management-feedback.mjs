...
artStatus=404;await click('Artwork');assert(text().includes('No artwork.'));assert(!document.querySelector('a[href^="/api/song-artwork"]'));await click('Close');
artStatus=503;await click('Artwork');assert(text().includes('Could not check artwork.'));assert(!document.querySelector('a[href^="/api/song-artwork"]'));artStatus=404;await click('Check again');assert(text().includes('No artwork.'));
